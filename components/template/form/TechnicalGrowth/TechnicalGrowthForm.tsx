...
import { TypeTechnicalGrowthFormComponentProps } from "@/lib/types/technicalGrowth.type"
...
const TechnicalGrowthForm = React.forwardRef<
  HTMLFormElement,
  TypeTechnicalGrowthFormComponentProps
